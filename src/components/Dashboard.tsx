      ...
      <header className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex items-center gap-3 text-gray-400 bg-surface-container-low/50 px-4 py-2 rounded-2xl border border-white/5 backdrop-blur-md">
            ...
            <div className="flex bg-surface-container-low/50 p-1 rounded-2xl border border-white/5 backdrop-blur-md">
              <button 
        ...
        {/* Global Balance Card */}
        <div className="bg-surface-variant/40 backdrop-blur-xl px-8 py-5 rounded-[2rem] border border-white/5 shadow-2xl flex flex-col items-end">
